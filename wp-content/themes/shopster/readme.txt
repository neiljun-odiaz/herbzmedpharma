*** Shopster Theme Documentation ***

== Theme Installation ==
Installing using FTP:

1. Unzip downloaded Shopster.zip file. New folder named "Shopster" will be created.
2. Connect to your FTP server and copy "Shopster" folder to your "wp-content/themes" directory.
...
2. Click "Install Themes" tab and then click "upload" link , select Shopster.zip file and click "Install Now".
