...
function icore_include_font() {
	...
	if ( isset( $theme_options['font_headline'] ) && $theme_options['font_headline'] != 'Helvetica-Neue'  ) {
        ...
        $css = 'h1, h2, h3, h4, h5, h6, ul.nav li a, #cart-menu-inner a.menu-link, ul.nav li.megamenu ul li a, .summary .price, .product .price { font-family: ' . $font_name .'; }';
    }
    ...
    if ( isset( $theme_options['font_body'] ) && $theme_options['font_body'] != 'Helvetica-Neue' ) {
        ...
        $css .= 'body, p, textarea, input, #tagline, ul.nav li.megamenu ul li ul li a, .widget_price_filter .price_slider_amount .button, .product a h3 { font-family: ' . $font_alt_name .'; }';
    }
...
function icore_add_custom_user_profile_fields( $user ) { ?>
	...
	<h3><?php _e( 'Profile Information', 'Shopster' ); ?></h3>
	<table class="form-table">
	<?php if ( current_user_can( 'manage_options' ) ) { ?>
		<tr>
			<th>
				<label for="staff"><?php _e( 'Staff Member', 'Shopster' ); ?>
			</label></th>
			<td>
				<input type="checkbox" name="staff" id="staff " value="1" <?php if (esc_attr( get_the_author_meta( "staff", $user->ID )) == "1") echo "checked"; ?> /><br />
				<span class="description"><?php _e( 'Check to mark as staff member', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="display_home"><?php _e( 'Display on homepage', 'Shopster' ); ?>
			</label></th>
			<td>
				...
				<span class="description"><?php _e( 'Check to display on homepage', 'Shopster' ); ?></span>
			</td>
		</tr>
		
			<tr>
				<th>
					<label for="display_archive"><?php _e( 'Display on team page', 'Shopster' ); ?>
				</label></th>
				<td>
					...
					<span class="description"><?php _e( 'Check to display on team page', 'Shopster' ); ?></span>
				</td>
			</tr>
		<?php } ?>
		<tr>
			<th>
				<label for="position"><?php _e( 'Position', 'Shopster' ); ?>
			</label></th>
			<td>
				...
				<span class="description"><?php _e( 'Enter your position.', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="twitter"><?php _e( 'Twitter', 'Shopster' ); ?>
			</label></th>
			<td>
				<input type="text" name="twitter" id="twitter" value="<?php echo esc_attr( get_the_author_meta( 'twitter', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Twitter url', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="facebook"><?php _e( 'Facebook', 'Shopster' ); ?>
			</label></th>
			<td>
				<input type="text" name="facebook" id="facebook" value="<?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Facebook url', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="googleplus"><?php _e( 'Google +', 'Shopster' ); ?>
			</label></th>
			<td>
				...
				<span class="description"><?php _e( 'Enter your Google + url', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="youtube"><?php _e( 'YouTube', 'Shopster' ); ?>
			</label></th>
			<td>
				<input type="text" name="youtube" id="youtube" value="<?php echo esc_attr( get_the_author_meta( 'youtube', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your YouTube url', 'Shopster' ); ?></span>
			</td>
		</tr>
		
		<tr>
			<th>
				<label for="vimeo"><?php _e( 'Vimeo', 'Shopster' ); ?>
			</label></th>
			<td>
				<input type="text" name="vimeo" id="vimeo" value="<?php echo esc_attr( get_the_author_meta( 'vimeo', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Vimeo url', 'Shopster' ); ?></span>
			</td>
		</tr>
