...
<div class="contact">
    ...
    <ul class="social">
		...
		<?php if ( ! empty( $contactPhone ) ) { ?>
			<li class="social phone icon-phone"><?php _e('Phone: ', 'Shopster'); ?><?php echo $contactPhone; ?></li>
		<?php } ?>
		
		<?php if ( ! empty( $contactAdd ) ) { ?>
			<li class="social address icon-phone"><?php _e('Address: ', 'Shopster'); ?><?php echo $contactAdd; ?></li>
		<?php } ?>
